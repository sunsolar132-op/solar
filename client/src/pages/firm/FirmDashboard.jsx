            ...
            <div className="panel-card space-y-4 shadow-xl shadow-red-100/30">
               {lowStock.length === 0 ? (
                 ...
                 <div key={idx} className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${
                   Number(item.stock) <= 0 ? 'bg-red-100 border-red-200' : 'bg-amber-50 border-amber-100'
                 }`}>
                    <div>
                       <div className="text-sm font-black text-slate-900">{item.name}</div>
                       <div className={`text-[10px] font-bold uppercase tracking-widest mt-0.5 ${
                         Number(item.stock) <= 0 ? 'text-red-600' : 'text-amber-600'
                       }`}>
                    ...
                    <div className="text-right">
                       <div className={`text-lg font-black ${
                         Number(item.stock) <= 0 ? 'text-red-700' : 'text-amber-700'
                       }`}>
